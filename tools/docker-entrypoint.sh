...
cp /opt/jboss/tools/standalone.xml /opt/jboss/keycloak/standalone/configuration/standalone.xml
mkdir -p /opt/jboss/keycloak/modules/system/layers/keycloak/org/postgresql/main/
cp /opt/jboss/tools/module.xml /opt/jboss/keycloak/modules/system/layers/keycloak/org/postgresql/main/module.xml
##################
# Start Keycloak #
##################
